# -*- coding: utf-8 -*-
#
# Emborg documentation build configuration file, created by
...
project = u'emborg'
copyright = u'2018-2019, Ken Kundert'
...
latex_documents = [
  ('index', 'emborg.tex', u'Emborg Documentation',
